---
  title: "Code Book"
  authoer:  Alexandra Hearn
  output: html_document
---
  
  # Data Source
  The tidyData database is a summary of a subset of the Human Activity Recognition Using Smartphones Data Set from UCI Machine Learning Repository.  
...
## Identifier
* SUBJECT               Person conducting the experiment
* Activity              Activity performed by the subject, represented by a code 
* Activity description  Description of the activity code

## Measurement
Measurements shown in the tidyData dataset is the mean of the group represented by a Subject - Activity combo.
